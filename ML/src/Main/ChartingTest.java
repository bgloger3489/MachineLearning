...
public class ChartingTest {//implements ExampleChart<XYChart>{
	public static void main(String[] args) {
	  ...
	  //for quadratic reggression:
	  
	  public XYChart gettChart(double[][] xxData, double[][] a, double[][] slope, double[][] yint, double[][] yyData) {
		    ...
		    for (int i = 0; i < xxData.length; i++) {
		      xData.add(xxData[i][0]);
		      y1Data.add(slope[0][0]*xxData[i][0] + yint[0][0] + a[0][0]*(xxData[i][0])*(xxData[i][0]) );
		    }
